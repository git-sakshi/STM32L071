...
#include "LC709203F.h"
/*
  @   Date               :        09.05.2020 / Monday
  @   Editor             :        Editing by Sakshi Baliyan 
...
{
	LC709203_IC_powerMode(hi2c1);
	LC709203_adjusmentPackApplicaiton(hi2c1);
	LC709203_changeOfTheParameter(hi2c1);
	LC709203_RSOC_initial(hi2c1);
	LC709203_statusBit(hi2c1);
	LC709203_RSOC_alarmLow(hi2c1);
}